...
export function Settings() {
  ...
  function onLogout() {
    ...
    localStorage.removeItem("leofy_user"); // por si guardas algo más, no pasa nada si no existe
    window.location.href = "/login";
    // Si NO usas rutas, puedes usar:
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 lg:p-8">
      ...
      <div className="mb-6 flex items-start justify-between gap-4">
        ...
        <button
          onClick={onLogout}
          className="px-4 py-2 bg-gray-50 text-[#1F2933] rounded-xl hover:bg-gray-100 transition-colors font-medium flex items-center gap-2"
          title="Cerrar sesión"
        >
      ...
      <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 mb-6">
        ...
        <Link
          to="/cards/manage"
          className="inline-flex items-center justify-center px-6 py-3 bg-[#2DD4BF] text-white rounded-xl hover:bg-[#14B8A6] transition-colors font-medium"
        >
          Manage Cards
        </Link>
      </div>
